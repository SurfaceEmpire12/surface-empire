...
const facebookUrl='https://www.facebook.com/profile.php?id=61593972853579';
const footerFacebook=document.querySelector('footer a[href="#"]');
if(footerFacebook && footerFacebook.textContent.trim()==='Facebook'){
footerFacebook.href=facebookUrl;footerFacebook.target='_blank';footerFacebook.rel='noopener noreferrer';
}
const buttons=document.querySelector('.hero .buttons');
if(buttons && !buttons.querySelector('.facebook-button')){
const fb=document.createElement('a');fb.className='btn outline facebook-button';fb.href=facebookUrl;fb.target='_blank';fb.rel='noopener noreferrer';fb.textContent='Follow Us on Facebook';buttons.appendChild(fb);
}
});